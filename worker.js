importScripts(
  ...
  // Main script asks for work. //Worker script 裡頭，在 worker.js 裡頭 self 就代表 Worker 本身(在html裡頭是指向 window Object)
  self.onmessage = async ({ data }) => {          // Main script asks for work.//使用 postMessage 發送訊息、onmessage 接收訊息
